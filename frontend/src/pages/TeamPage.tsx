...
export function TeamPage() {
  ...
  if (!team && currentUser?.role !== 1) {
    return <section className="page-section narrow ui-v2-page team-page"><div className="page-header"><div><h1>战队</h1></div></div>{error && <div className="alert error">{error}</div>}<button className="button primary" onClick={() => navigate("/admin/teams")}>进入战队管理</button></section>;
  }
