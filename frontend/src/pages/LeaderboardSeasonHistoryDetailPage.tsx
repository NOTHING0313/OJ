...
export function LeaderboardSeasonHistoryDetailPage() {
  ...
  return <section className="challenge-page leaderboard-page leaderboard-v2-page season-operations-page">
    <div className="leaderboard-header leaderboard-v2-header"><div><p className="eyebrow">FINAL STANDINGS</p><h1>{archive.seasonName}</h1><p>最终排名 · 归档快照</p></div><Link className="button" to="/leaderboards/history">返回历史赛季</Link></div>
